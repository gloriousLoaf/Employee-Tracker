...
// called by callDep in app.js, returns array of Department names
const queryDep = () => {
...
// called by viewDep, returns table of employees by department DOESN'T INCLUDE managers as their own row :(
...
// sends addEmp() info class constructor to MySQL Database
const empSQL = (newEmp) => {
...
// sends addDep class constructor to MySQL Database
const depSQL = (newDep) => {
...
// sends addRole() info class constructor to MySQL Database
